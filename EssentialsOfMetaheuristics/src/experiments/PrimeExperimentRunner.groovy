...
import problems.PrimeEvolution
...
//			new HIFF(numBits : 32, maxIterations : 1000)
			new PrimeEvolution(numBits : 10, maxIterations : 20),
			new PrimeEvolution(numBits : 15, maxIterations : 20),
			new PrimeEvolution(numBits : 20, maxIterations : 20)
		]
		// It would be nice to collect the total time here and include it in the
		// output.
		runExperiment(searchers, problems, 10)
	}
